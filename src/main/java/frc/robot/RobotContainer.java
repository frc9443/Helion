...
public class RobotContainer {
  ...
  public RobotContainer() {
      ...
      case SIM:
        ...
        drive =
            new Drive(
                ...
                new ModuleIOSim());
        flywheel = new Flywheel(new FlywheelIOSim());
        vision = new Vision(drive::addVisionMeasurement, new VisionIOPhotonVisionSim("photonvision", robotToCamera0, drive::getPose));
        break;
    ...
    NamedCommands.registerCommand(
        "Run Flywheel",
        Commands.startEnd(
                () -> flywheel.runVelocity(RotationsPerSecond.of(flywheelSpeedInput.get() / 60.0)), flywheel::stop, flywheel)
            .withTimeout(5.0));
